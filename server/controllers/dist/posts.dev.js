...
exports.likePosts = exports.getUserPosts = exports.getFeedPosts = exports.createPost = void 0;
...
var likePosts = function likePosts(req, res) {
  ...
  return regeneratorRuntime.async(function likePosts$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 5;
          return regeneratorRuntime.awrap(_Post["default"].findById(id));
        ...
        case 5:
          ...
          _context4.next = 10;
          return regeneratorRuntime.awrap(_Post["default"].findByIdAndUpdate(id, {
            likes: post.likes
          }, {
            "new": true
          }));
